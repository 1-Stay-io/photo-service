...
# arangoimport --file "/Users/marcuslee/Desktop/HR/SDC/service/db/arango/arangoJSON/jsonListing.json" --type json --collection "listings" --create-collection true --batch-size 33554432 --progress true --threads 4 --server.database "stayio";